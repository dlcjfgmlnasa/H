...
#     torch.manual_seed(0)
#     bsz, in_channels, t_len = 2, 6, 5033  # Use an arbitrary length
#
#     # --- Single modality input ---
#     single_input = torch.randn(bsz, in_channels, t_len)
#
...
#
#     # --- Run forward pass ---
#     model.train()  # Set to train mode to check for errors
#     y = model(single_input)
#
#     print(f"Input shape:  {single_input.shape}")
#     print(f"Output shape: {y.shape}")
#
#     # --- Verify output shape ---
#     assert y.shape == (bsz, 5, t_len)
#     print("\nModel ran successfully, and the output shape is correct!")