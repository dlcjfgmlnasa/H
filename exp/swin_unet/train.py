...
from exp.swin_unet.model import SwinUnet1D
...
def get_args():
    ...
    parser.add_argument('--dataset_name', default='heartsound', choices=['heartsound', 'heartbeat', 'ahi'])
...
class Trainer(object):
    ...
    def run(self):
        ...
        file_path = os.path.join(args.save_path, args.dataset_name, 'swin_unet.json')
